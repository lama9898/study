...
public class MaxDepartementForBudget {
	...
	/*
		...
		1,000원보다 적은 금액을 지원해 줄 수는 없습니다. 부서별로 신청한 금액이 들어있는 배열 d와 예산 budget이 매개변수로 주어질 때,
	...
	public int otherSolution(int[] d, int budget) {
		int answer = 0;
